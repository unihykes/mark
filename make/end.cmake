...
IF(${NEED_BOOSTBCP})
	...
	SET(LINK_BOOSTBCP_LIBS boostbcp)
...
IF(${NEED_GTEST})
	...
	SET(LINK_GTEST_LIBS ${LINK_GTEST_LIBS} gmock)
	IF("${CMAKE_SYSTEM_NAME}" STREQUAL "Linux")
...
# 依赖 NEED_MKCORE
IF(${NEED_MKCORE})
	ADD_DEFINITIONS(-D__USING_MKCORE__)
	INCLUDE_DIRECTORIES(${MONK_SRC}/mkcore/include;
						${MONK_SRC}/mkcore/src;)
	SET(LINK_CUSTOM_LIBS ${LINK_CUSTOM_LIBS} mkcore)
ENDIF()

# 设置所有的链接库
SET(LINK_ALL_LIBS   ${LINK_BOOSTBCP_LIBS}
                    ${LINK_GTEST_LIBS}
                    ${LINK_CUSTOM_LIBS}
    )
