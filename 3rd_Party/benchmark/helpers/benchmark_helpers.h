...
class ncTest2Benchmark : public benchmark::Fixture
{
public:
    ncTest2Benchmark(const string& name)
    {
        //必须有名称,否则无法注册
        SetName(name.c_str());
    }
